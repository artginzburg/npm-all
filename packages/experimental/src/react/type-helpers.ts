/**
 * You can use this type to pass props that are not optimal to be passed by {@link ReactStateTuple} due to being also used in the passing component.
 *
 * @example
...
/**
 * The type returned by {@link React.useState}. Useful for passing the whole state through just one component prop.
 *
 * @example
...
/**
 * The type of the second element returned by {@link React.useState}. Just a shortcut to have one generic type instead of a sequence of two.
 *
 * @example
